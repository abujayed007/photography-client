...
const BannerItems = ({ banner }) => {
    ...
    return (
        ...
        <div className="absolute  justify-between  transform -translate-y-1/2  right-80 -mx-64 top-2/4">
          <h1 className="text-cyan-500 text-3xl my-4"> <strong className='text-4xl text-orange-600'>Hire Me</strong> <br /><strong className='underline decoration-4 text-purple-400'>For Event</strong> <br /> <strong className='text-4xl text-orange-600 '>Photography</strong></h1>
