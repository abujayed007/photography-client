...
const BannerItems = ({ banner }) => {
    ...
    return (
        ...
        <img className='h-1/2  lg:w-72 rounded ' src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRT0HEXRNxJiysIICKEoESvGLGNuGGm5Hzah21vLgHKgg_w5uQAV0AYz_zuUtdV4Y9qsJ4&usqp=CAU" alt="" />
        <img className='h-1/2  lg:w-72 rounded my-5' src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS9EQc-b0iB8QAvB-P9PS6lmosmjLxWZQYATw&usqp=CAU" alt="" />
        <img className='h-1/2  lg:w-72 rounded my-5' src="https://s.studiobinder.com/wp-content/uploads/2021/04/Event-Photography-Tips-and-Tricks-for-All-Photographers-StudioBinder.jpg" alt="" />
